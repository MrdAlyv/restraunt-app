        ...
        <div className="container mx-auto px-4 lg:px-0">
            <div className='flex flex-row  justify-around items-center'>
                ...
                <div>
                    ...
                    <h1 className='text-start text-4xl  font-extrabold'>Restaurant</h1>
            ...
            <div className='flex flex-row justify-around items-center mt-28 '>
                ...
                <div className='w-[500px] h-[500px] flex justify-center items-center bg-gray rounded-full'>
                    <Image src={aboutimg2} alt='img' width={400} height={400} layout="responsive" />
                </div>
            </div>
            <div className='flex flex-row justify-around items-center mt-28'>
                <div >
                    <Image src={aboutChef} alt='chef' width={300} height={500} layout="responsive" />
                </div>
                <div>
